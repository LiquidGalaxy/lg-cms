...
class Panorama(Item):
    ...
    hfov = models.DecimalField(blank=True, max_digits=5, decimal_places=2, default=360.0,
    ...
    vfov = models.DecimalField(blank=True, max_digits=5, decimal_places=2, # default=180.0,
    ...
    voffset = models.DecimalField(blank=True, max_digits=5, decimal_places=2, # default=0.0,
